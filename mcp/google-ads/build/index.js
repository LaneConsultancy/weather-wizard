...
// Create MCP server
const server = new Server({ name: "google-ads", version: "1.0.0" }, { capabilities: { tools: {} } });
// Define all tools
const tools = [
    {
    ...
    try {
        ...
        `;
            ...
            case "google_ads_remove_ads": {
                ...
                const resourceNames = ad_ids.map((ad_id) => `customers/${process.env.GOOGLE_ADS_CUSTOMER_ID}/adGroupAds/${ad_id}`);
