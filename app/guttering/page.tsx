...
export default function GutteringPage() {
  ...
  // LocalBusiness structured data — developer-authored controlled content
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* Structured data — developer-authored controlled content, not user input */}
      <script
      ...
      {/* Minimal brand bar — logo + phone only, no site navigation */}
      ...
      <section className="bg-slate-900 py-12 md:py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
            Get a free quote for your guttering and I&apos;ll tell you exactly
