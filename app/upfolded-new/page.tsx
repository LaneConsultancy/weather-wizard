...
export const metadata: Metadata = {
  title: "Get Your Roof Fixed - Free Quote | Weather Wizard",
  description:
    "Don't let a small leak become a big problem. Get a free, no-obligation roofing quote from a trusted Kent roofer with 25 years' experience.",
  robots: {
    index: false,
    follow: false,
  },
...
export default function UpfoldedNewPage() {
  return (
      ...
      <section className="bg-slate-900 py-12 md:py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
            Get a free quote for your Kent roof and I&apos;ll tell you exactly
