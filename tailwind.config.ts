...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Primary - Slate (sophisticated blue-grey)
        slate: {
          DEFAULT: '#1e293b',
          50: '#f8fafc',
          100: '#f1f5f9',
      ...
      boxShadow: {
        ...
        'soft-xl': '0 20px 50px -12px rgba(0, 0, 0, 0.15), 0 8px 30px -8px rgba(0, 0, 0, 0.06)',
        'copper': '0 10px 40px -10px rgba(234, 88, 12, 0.3)',
        'copper-lg': '0 20px 50px -12px rgba(234, 88, 12, 0.4)',
